...
$(document).ready(function() {
	...
	$('.type').on('click', function() {
		if (isOpen === false) {
			...
			$('#type-about-descr').typeIt({
				strings: ['A few words about myself'],
				speed: 100,
				startDelay: 3000,
				cursor: false
			});
			...
			$('#type-works-descr').typeIt({
				strings: ['Some of my latest work'],
				speed: 100,
				startDelay: 3500,
				cursor: false
			});
			$('#type-skills').typeIt({
				strings: ['My technical skills'],
				speed: 140,
				startDelay: 1500
			});
			$('#type-skills-descr').typeIt({
				strings: ['What I do'],
				speed: 100,
				startDelay: 4500,
				cursor: false
	...
	$('.bl-box').on('click', function() {
		$('.bl-content__title, .bl-content__descr').removeClass("hidden");
		$('.bl-content__title, .bl-content__descr').addClass("visible");
	});
	$('.close').on('click', function() {
		$('.bl-content__title, .bl-content__descr').removeClass("visible");
		$('.bl-content__title, .bl-content__descr').addClass("hidden");
	});

	// tippy.js - promt to resume =====================
	...
	tippy('#resume', {
		...
		hideOnClick: 'true',
		touchHold: true,
		appendTo: document.querySelector('.bl-content'),
		flipDuration: 9999999,
		popperOptions: {
			modifiers: {
				flip: {
					behavior: ['right', 'top']
	...
	// tippy.js - promt to social =====================

	tippy('.vk, .skype, .github, .linkedin', {
		position: 'bottom',
		animation: 'scale',
		duration: 500,
		arrow: true,
	...
	tippy('#mail', {
		...
		hideOnClick: 'true',
		touchHold: true,
		appendTo: document.querySelector('.for-promt-mail'),
		flipDuration: 9999999,
		popperOptions: {
			modifiers: {
				flip: {
...
// Wow - анимация =====================
	...
	var about = document.getElementById("about-animation");
	var works = document.getElementById("bl-work-section");
	var skills = document.getElementById("skills-animation");
	var contact = document.getElementById("contact-animation");
	var logo = document.getElementById("logocontainer");

	about.addEventListener("mouseover",aboutretina,false);
	about.addEventListener("touchstart",aboutretina,false);
	works.addEventListener("mouseover",worksretina,false);
	works.addEventListener("touchstart",worksretina,false);
	skills.addEventListener("mouseover",skills3retina,false);
	skills.addEventListener("touchstart",skills3retina,false);
	contact.addEventListener("mouseover",contactretina,false);
	contact.addEventListener("touchstart",contactretina,false);
	logo.addEventListener("mouseover",logoretina,false);
	logo.addEventListener("touchstart",logoretina,false);

	function aboutretina(event) {
		TweenMax.to("#eyes, #eyes-small", 0.2, {left:"49.4%",top:"36.8%"});
	}

	function worksretina(event) {
		TweenMax.to("#eyes, #eyes-small", 0.2, {left:"51.4%",top:"36.8%"});
	}

	function skills3retina(event) {
		TweenMax.to("#eyes, #eyes-small", 0.2, {left:"49.4%",top:"39.9%"});
	}

	function contactretina(event) {
		TweenMax.to("#eyes, #eyes-small", 0.2, {left:"51.4%",top:"39.9%"});
	}

	function logoretina(event) {
		TweenMax.to("#eyes, #eyes-small", 0.2, {left:"50.4%",top:"38.3%"});
	}

	// Hidden man-animation =====================
	...
	$('.bl-box').on('click', function() {
		$('.skills-logo-a').animateCss("flipInY");
		$('.tools-logo').animateCss("fadeIn");
		$('.bl-content__items-l').animateCss("zoomIn");
		$('.bl-content__items-r').animateCss("zoomIn");
		$('.social-title').animateCss("flash");
	});

	$('.close').on('click', function() {
		$('.skills-logo-a, .tools-logo, .bl-content__items-l, .bl-content__items-r, .social-title').removeClass("animated");
		$('.bl-content__items-l, .bl-content__items-r').removeClass("zoomIn");
		$('.skills-logo-a').removeClass("flipInY");
		$('.tools-logo').removeClass("fadeIn");
		$('.social-title').removeClass("flash");
	});

	// Main title animation =====================

	$('.close-a').on('click', function() {
		$('.bl-icon-about').animateCss("fadeIn");
	});

	$('.close-w').on('click', function() {
		$('.bl-icon-works').animateCss("fadeIn");
	});

	$('.close-s').on('click', function() {
		$('.bl-icon-skills').animateCss("fadeIn");
	});

	$('.close-c').on('click', function() {
		$('.bl-icon-contact').animateCss("fadeIn");
	});

	$('.bl-box').on('click', function() {
		$('.bl-icon-about, .bl-icon-works, .bl-icon-skills, .bl-icon-contact').removeClass("animated");
		$('.bl-icon-about, .bl-icon-works, .bl-icon-skills, .bl-icon-contact').removeClass("fadeIn");
	});
