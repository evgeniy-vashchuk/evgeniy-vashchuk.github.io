				...
				preloaderForHomeStripAnimation = new TimelineMax({
					onUpdate: function() {
						...
						function loadingTextShowing() {
							var loadingTextItemHeight = Math.round($(preloaderLoadingText.find('li')[0]).outerHeight(true)),
...
function documentReadyScripts() {
	...
	$('#js-contact-form').validate({
		submitHandler: function(form) {
			$.ajax({
				url: '//formspree.io/evgeniy.vashchuk.mail@gmail.com',
				method: 'POST',
				data: $(form).serialize(),
				dataType: 'json',
