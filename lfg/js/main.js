...
/***/ "./src/js/components/active-header-after-scroll.js"
/*!*********************************************************!*\
  !*** ./src/js/components/active-header-after-scroll.js ***!
  \*********************************************************/
...
/* harmony export */ });
const initActiveHeaderAfterScroll=()=>{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initActiveHeaderAfterScroll);
...
const initCountUp=()=>{
const countUpItems=document.querySelectorAll('.js-count-up');

if(!countUpItems.length)return;

countUpItems.forEach((el)=>{
let countNumber=el.getAttribute('data-count-number');
let numbersAfterComma=0;

const preffix=el.getAttribute('data-preffix');
...
new countup_js__WEBPACK_IMPORTED_MODULE_0__.CountUp(el,countNumber,options).start();
});
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initCountUp);
...
const initLazyLoad=()=>{
const lazyLoadInstance=new vanilla_lazyload__WEBPACK_IMPORTED_MODULE_1__({
elements_selector:'.js-lazy',
threshold:0,
callback_loaded:(el)=>{
const transitionSpeed=parseFloat(getComputedStyle(el).transitionDuration)*1000;

setTimeout(()=>{
if(el.classList.contains('js-svg-inject')){
_iconfu_svg_inject__WEBPACK_IMPORTED_MODULE_0__(el);
}
},transitionSpeed);
}
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initLazyLoad);
...
const initModal=()=>{
const modalNewsletterElement=document.querySelector('#modal-newsletter');

if(!modalNewsletterElement)return;

const modalNewsletter=new _main_js__WEBPACK_IMPORTED_MODULE_1__.Bootstrap.Modal(modalNewsletterElement);

const showModalNewsletter=()=>{
if(window.innerWidth<_utils_constants__WEBPACK_IMPORTED_MODULE_0__.breakpoints.md){
setTimeout(()=>{
...
showModalNewsletter();
window.addEventListener('resize',showModalNewsletter);
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initResizeAnimationStopper);
...
const initSliders=()=>{
const sliderTestimonialsElement=document.querySelector('.js-slider-testimonials');
const sliderTestimonialsPaginationElement=sliderTestimonialsElement?.closest('.swiper-holder').querySelector('.swiper-pagination');

const sliderTestimonials=new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderTestimonialsElement,{
modules:[swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination,swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay],
slidesPerView:1,
spaceBetween:_utils_constants__WEBPACK_IMPORTED_MODULE_2__.gridGutterWidth,
speed:700,
createElements:true,
loop:true,
...
clickable:true,
enabled:true,
el:sliderTestimonialsPaginationElement||null,
...
const activeBullet=s.pagination.bullets.find((bullet)=>bullet.classList.contains('swiper-pagination-bullet-active'));

if(activeBullet){
activeBullet.querySelector('.swiper-pagination-bullet-progress').style.width=`${percentage}%`;
}
}
}
});

const sliderSocialsElements=document.querySelectorAll('.js-slider-socials');

sliderSocialsElements.forEach((sliderSocialsElement)=>{
const sliderSocials=new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderSocialsElement,{
...
autoplay:{
delay:0,
reverseDirection:sliderSocialsElement.dataset.direction==='reverse',
disableOnInteraction:false,
...
/***/ "./src/js/components/smooth-anchor-links.js"
/*!**************************************************!*\
  !*** ./src/js/components/smooth-anchor-links.js ***!
  \**************************************************/
(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
const anchorLinks=document.querySelectorAll('a[href*="#"]:not([href="#"]):not(.js-no-scroll):not([data-bs-toggle="modal"])');
const urlHash=window.location.href.split('#')[1];
const urlHashElement=urlHash?document.querySelector('#'+urlHash):null;

const getItemDistanceFromTop=(element)=>{
if(!element)return;

const header=document.querySelector('.js-header.fixed-top');
const headerOffset=header?header.offsetHeight:0;
const distanceFromTop=element.offsetTop-headerOffset+1;

return distanceFromTop;
};

const smoothScrollTo=function(to){let duration=arguments.length>1&&arguments[1]!==undefined?arguments[1]:1000;let callback=arguments.length>2?arguments[2]:undefined;
...
const closeOffcanvas=(link)=>{
const offcanvasElement=link?.closest('#offcanvas-menu');
const offcanvasInstance=_main_js__WEBPACK_IMPORTED_MODULE_1__.Bootstrap.Offcanvas.getInstance(offcanvasElement);
...
const idOfElement=href.includes('#')?'#'+href.split('#')[1]:href;
const targetElement=document.querySelector(idOfElement);
const distanceFromTop=getItemDistanceFromTop(targetElement);

if(!distanceFromTop)return;

closeOffcanvas(this);
smoothScrollTo(distanceFromTop);
});
});

if(urlHash&&urlHashElement){
setTimeout(function(){
const distanceFromTop=getItemDistanceFromTop(urlHashElement);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initSmoothAnchorLinks);
...
const textAnimationSelector=`.js-slide-up-text, .js-slide-up-inner-headings :is(${headingTags})`;
const textAnimationElements=document.querySelectorAll(textAnimationSelector);

if(!textAnimationElements.length)return;

gsap__WEBPACK_IMPORTED_MODULE_0__["default"].registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger,gsap_SplitText__WEBPACK_IMPORTED_MODULE_2__.SplitText);

textAnimationElements.forEach((text)=>{
const splitText=new gsap_SplitText__WEBPACK_IMPORTED_MODULE_2__.SplitText(text,{
type:'words',
wordsClass:'word'
});

splitText.words.forEach((wordEl)=>{
const inner=document.createElement('span');

inner.className='word-inner';

while(wordEl.firstChild){
inner.appendChild(wordEl.firstChild);
}

wordEl.appendChild(inner);
});

const innerWords=text.querySelectorAll('.word-inner');

gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(innerWords,{y:'120%'});
...
/* harmony import */ var _components_active_header_after_scroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @components/active-header-after-scroll */ "./src/js/components/active-header-after-scroll.js");
/* harmony import */ var _components_animations_on_scroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @components/animations-on-scroll */ "./src/js/components/animations-on-scroll.js");
/* harmony import */ var _components_count_up__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @components/count-up */ "./src/js/components/count-up.js");
...
/* harmony import */ var _components_resize_animation_stopper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @components/resize-animation-stopper */ "./src/js/components/resize-animation-stopper.js");
...
/* harmony import */ var _components_smooth_anchor_links__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @components/smooth-anchor-links */ "./src/js/components/smooth-anchor-links.js");
/* harmony import */ var _components_text_animation__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @components/text-animation */ "./src/js/components/text-animation.js");



const Bootstrap={
Modal: bootstrap_js_dist_modal_js__WEBPACK_IMPORTED_MODULE_0__,
Offcanvas: bootstrap_js_dist_offcanvas_js__WEBPACK_IMPORTED_MODULE_1__
};
...
(0,_components_resize_animation_stopper__WEBPACK_IMPORTED_MODULE_7__["default"])();
(0,_components_sliders__WEBPACK_IMPORTED_MODULE_8__["default"])();
...
(0,_components_text_animation__WEBPACK_IMPORTED_MODULE_10__["default"])();
(0,_components_count_up__WEBPACK_IMPORTED_MODULE_4__["default"])();
(0,_components_smooth_anchor_links__WEBPACK_IMPORTED_MODULE_9__["default"])();
...
/* harmony export */   gridGutterWidth: () => (/* binding */ gridGutterWidth)
/* harmony export */ });
const breakpoints={
