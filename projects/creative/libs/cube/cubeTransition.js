...
if (navigator.appName === 'Microsoft Internet Explorer' || !!(navigator.userAgent.match(/Trident/) || navigator.userAgent.match(/rv:11/)) || (typeof $.browser !== "undefined" && $.browser.msie === 1))
{
	...
	for (var i = 0; i < length; i++) {
		...
		var bullet = $("<li><span class='page-title' data-section="+ (+[i] + 1) +">" + tooltip_text +"</span><span class='stick'></span><span class='hover-title' data-section="+ (+[i] + 1) +">" + tooltip_text +"</span></li>");
	...
	function show() {
		...
		// text side animation
		$(".-section.visible .side-animation-item").addClass('side-animation-action');
	...
	$(document).ready(function() {
		...
		// ARROW DOWN 
		$('.js-arrow-down-cube').on('click', function() {
			trans('down');
			barsAnimation();
		});
