	...
	create: function( options ) {
		return (function(){
			...
			function setupPositions() {
				...
				switch( config.position ) {
					...
					case POSITION_R:
						...
						menuTransformClosed = 'rotateY( ' + menuAngle + 'deg ) translateX( 100% )';
			...
			function setupCover() {
				...
				dom.cover.className = "cube-menu-overlay";
			...
			function onTouchMove( event ) {
				...
				if( Math.abs( touchMoveX - touchStartX ) > Math.abs( touchMoveY - touchStartY ) ) {
					...
					var swipeRightWidthArea = 50;
					if((touchStartX > intViewportWidth - swipeRightWidthArea) && touchMoveX < touchStartX - config.threshold ) {
